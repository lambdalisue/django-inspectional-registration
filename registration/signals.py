...
SIGNALS:
    user_registered     -- sent when user has registered by Backend
    user_accepted       -- sent when user registration has accepted by Backend
    user_rejected       -- sent when user registration has rejected by Backend
    user_activated      -- sent when user has activated by Backend
